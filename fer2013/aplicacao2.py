...
# Configurações
IMG_HEIGHT, IMG_WIDTH = 48, 48  # Dimensões das imagens esperadas pelo modelo
CLASS_NAMES = ['boa', 'ruim']  # Ajuste conforme as classes do modelo

# Carregar o modelo treinado
model = tf.keras.models.load_model('fer2013_cnn_model.h5')
